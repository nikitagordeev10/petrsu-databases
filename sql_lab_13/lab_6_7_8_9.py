...
def view_lessons():
    ...
    for i, row in enumerate(rows):
        ...
        tk.Button(table_container, text=row[2], bg="white", command=lambda lesson_id=row[-1]: open_lesson_details(lesson_id)).grid(row=i+1, column=2, sticky="nsew", columnspan=1) 
